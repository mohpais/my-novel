        ...
        <Card>
            <template #header>
                <div
                    class="flex items-center justify-center w-12 h-12 bg-gray-100 rounded-xl dark:bg-gray-800"
                >
                    <svg width="24" height="24" class="fill-gray-800 dark:fill-white/90" fill="none" viewBox="0 0 24 24" transform="" id="injected-svg">
                        <path d="m19,3H5c-1.1,0-2,.9-2,2v14c0,1.1.9,2,2,2h14c1.1,0,2-.9,2-2V5c0-1.1-.9-2-2-2ZM5,19V5h14v14s-14,0-14,0Z"/>
                        <path d="M8.5 10.5A1.5 1.5 0 1 0 8.5 13.5 1.5 1.5 0 1 0 8.5 10.5z"/>
                        <path d="M11 11H17V13H11z"/>
                        <path d="M7 7H17V9H7z"/>
            ...
            <div class="flex items-end justify-between mt-5">
                <div>
                <span class="text-sm text-gray-500 dark:text-gray-400">Requests</span>
                <h4 class="mt-2 font-bold text-gray-800 text-title-sm dark:text-white/90">5,359</h4>
                </div>

                <span
                @click="toast('Test toast di AdminLayout', { type: 'success' })"
                class="flex cursor-pointer items-center gap-1 rounded-full bg-error-50 py-0.5 pl-2 pr-2.5 text-sm font-medium text-error-600 dark:bg-error-500/15 dark:text-error-500"
                >
                <svg
                    class="fill-current"
                    width="12"
