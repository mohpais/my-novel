<template>
    <div class="flex items-center justify-center gap-1 mt-1" v-if="!userStore.isLoading.getApplicantResponsePagination">
        <Button
            size="sm"
            @click="userStore.btnClickAction('open', params.data)"
