            ...
            >
                <slot name="right">
                    ...
                    <div v-else class="hidden sm:flex">
                        <router-link to="/login" class="loginBtn px-[22px] py-2 font-medium text-white hover:opacity-70">
                            Sign In
                        </router-link>
                        <router-link to="/register" class="px-6 py-2 font-medium text-white duration-300 ease-in-out rounded-md bg-white/20 signUpBtn hover:bg-white/100 hover:text-gray-800">
                            Sign Up
                        </router-link>
                    </div>
                </slot>
...
<script setup>
import { ref } from 'vue'
import { tryUseSidebar } from '@/composables/useSidebar'
import ThemeToggler from '../ThemeToggler.vue'
import HeaderLogo from './HeaderLogo.vue'
import NotificationMenu from './NotificationMenu.vue'
import UserMenu from './UserMenu.vue'

const sidebar = tryUseSidebar()
const isMobileOpen = sidebar?.isMobileOpen ?? ref(false);
